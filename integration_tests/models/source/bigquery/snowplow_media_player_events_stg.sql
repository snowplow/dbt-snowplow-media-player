...
select
  *
  ...
  JSON_EXTRACT_ARRAY(unstruct_event_com_snowplowanalytics_snowplow_media_ad_quartile_event_1_0_0) AS unstruct_event_com_snowplowanalytics_snowplow_media_ad_quartile_event_1_0_0
  ...
  *
  ...
  array(
    select as struct JSON_EXTRACT_scalar(json_array,'$.current_time') as current_time,
                    ...
                    JSON_EXTRACT_scalar(json_array,'$.ended') as ended,
                    JSON_EXTRACT_scalar(json_array,'$.fullscreen') as fullscreen,
                    JSON_EXTRACT_scalar(json_array,'$.livestream') as livestream,
                    JSON_EXTRACT_scalar(json_array,'$.label') as label,
                    JSON_EXTRACT_scalar(json_array,'$.loop') as loop,
                    JSON_EXTRACT_scalar(json_array,'$.media_type') as media_type,
                    JSON_EXTRACT_scalar(json_array,'$.muted') as muted,
                    JSON_EXTRACT_scalar(json_array,'$.paused') as paused,
                    JSON_EXTRACT_scalar(json_array,'$.picture_in_picture') as paused,
                    JSON_EXTRACT_scalar(json_array,'$.playback_rate') as playback_rate,
  ...
  array(
    select as struct JSON_EXTRACT_scalar(json_array,'$.media_session_id') as media_session_id,
                    ...
                    JSON_EXTRACT_scalar(json_array,'$.ads') as ads,
                    JSON_EXTRACT_scalar(json_array,'$.ads_clicked') as ads_clicked,
                    JSON_EXTRACT_scalar(json_array,'$.ads_skipped') as ads_skipped,
                    JSON_EXTRACT_scalar(json_array,'$.ads_skipped') as ads_skipped,
                    JSON_EXTRACT_scalar(json_array,'$.ad_breaks') as ad_breaks,
  ...
  array(
    select as struct JSON_EXTRACT_scalar(json_array,'$.name') as name,
                    ...
                    JSON_EXTRACT_scalar(json_array,'$.pod_position') as pod_position,
                    cast(JSON_EXTRACT_scalar(json_array,'$.duration') as float64) as duration,
                    JSON_EXTRACT_scalar(json_array,'$.skippable') as skippable
  ...
  array(
    select as struct JSON_EXTRACT_scalar(json_array,'$.percent_progress') as percent_progress
    from unnest(unstruct_event_com_snowplowanalytics_snowplow_media_ad_quartile_event_1_0_0) as json_array
