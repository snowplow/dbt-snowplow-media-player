...
with prep as (
  select
    ...
    from_json(unstruct_event_com_snowplowanalytics_snowplow_media_ad_quartile_event_1_0_0, 'array<struct<percent_progress:string>>') as unstruct_event_com_snowplowanalytics_snowplow_media_ad_quartile_event_1
